...
//Get All expense types
  Future<void> getClaimConfirmResons(
    ...
    var getAllTypesAPI =
        "http://scm-stg.abans.com:1081/api/v1/SFA/Visitclaimtype";
  ...
  Future<void> getClaimHistory(
    ...
    var getClaimHistoryAPI =
        "http://scm-stg.abans.com:1081/api/v1/SFA/getvisitclaimdata";
  ...
  Future<void> saveClaimRequest({
    ...
    var saveClaimAPI = "http://scm-stg.abans.com:1081/api/v1/SFA/Visitclaimadd";
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onTap: () async {
                            ...
                            // ClaimDialog()
                            //     .selectSerialDialog(context, items);
                            setState(() {
                              selectedExpenseType = '';
                              withBill = false;
                              imageList.clear();
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ClaimColumn(
                                    title: "Month",
                                    value: formatDate(DateTime.now(), [MM]),
                                  ),
                                  const ClaimColumn(
                                    title: "Base Location",
                                    value: "Colombo 05",
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5.0),
                            color: const Color.fromARGB(255, 223, 197, 251),
                            boxShadow: const [
                              BoxShadow(
                                color: Colors.deepPurple,
                                offset: Offset(0.0, 1.0), //(x,y)
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: CustomText(
                                    text: claimHistoryList[index].SAVCD_TYPE!,
                                    fontSize: 12,
                                    textAlign: TextAlign.center,
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                ...
                                child: Column(
                                  children: [
                                    ListViewTile(
                                      title: 'Amount',
                                      value:
                                          claimHistoryList[index].SAVCD_AMOUNT!,
                                    ),
                                    ListViewTile(
                                      title: 'Remark',
                                      value:
                                          claimHistoryList[index].SAVCD_REMARK!,
                                    ),
                                  ],
                                ),
                              ),
